...
<section style="background:#f9fafb;padding:56px 20px;border-top:1px solid #e5e7eb;">
    <div style="max-width:1100px;margin:0 auto;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:14px;">
            ...
            <a href="/facilities/{{ $center->name_id }}" style="display:flex;gap:14px;background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:16px;text-decoration:none;transition:all .15s;color:inherit;" onmouseover="this.style.borderColor='#065f46';this.style.boxShadow='0 4px 12px rgba(6,95,70,.1)'" onmouseout="this.style.borderColor='#e5e7eb';this.style.boxShadow='none'">
...
<section style="background:linear-gradient(135deg,#065f46 0%,#047857 100%);padding:48px 20px;">
    <div style="max-width:900px;margin:0 auto;display:grid;grid-template-columns:1fr auto;gap:40px;align-items:center;flex-wrap:wrap;">
        <div>
            <div style="display:inline-block;background:rgba(255,255,255,.15);color:#6ee7b7;padding:4px 12px;border-radius:20px;font-size:.78rem;font-weight:700;margin-bottom:14px;">FINANCIAL ASSISTANCE</div>
