...
{{-- HERO --}}
<section style="background:linear-gradient(135deg,#1e40af 0%,#2563eb 50%,#0ea5e9 100%);padding:80px 20px 60px;margin-top:64px;">
...
<section style="background:#fff;padding:32px 20px;border-bottom:1px solid #e5e7eb;">
    <div style="max-width:900px;margin:0 auto;display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:20px;text-align:center;">
        <div><div style="font-size:2rem;font-weight:800;color:#2563eb;">26,000+</div><div style="font-size:.85rem;color:#666;">Licensed Centers</div></div>
        <div><div style="font-size:2rem;font-weight:800;color:#2563eb;">50</div><div style="font-size:.85rem;color:#666;">States Covered</div></div>
        <div><div style="font-size:2rem;font-weight:800;color:#2563eb;">41k+</div><div style="font-size:.85rem;color:#666;">ZIP Codes Indexed</div></div>
        <div><div style="font-size:2rem;font-weight:800;color:#2563eb;">Free</div><div style="font-size:.85rem;color:#666;">Always Free to Search</div></div>
    </div>
</section>
...
<section style="background:#f8fafc;padding:48px 20px;">
    <div style="max-width:1100px;margin:0 auto;">
        ...
        <div style="text-align:center;margin-top:24px;">
            <a href="/facilities" style="display:inline-block;background:#2563eb;color:#fff;padding:13px 28px;border-radius:8px;font-weight:700;text-decoration:none;">Browse All Centers</a>
        </div>
    </div>
</section>
@endif
...
<section style="background:#fff;padding:48px 20px;">
    <div style="max-width:1100px;margin:0 auto;">
        <h2 style="font-size:1.5rem;font-weight:700;color:#1e3a5f;margin-bottom:24px;">Browse by State</h2>
...
<section style="background:#fff;padding:48px 20px;">
    <div style="max-width:760px;margin:0 auto;">
        <h2 style="font-size:1.5rem;font-weight:700;color:#1e3a5f;margin-bottom:24px;text-align:center;">Frequently Asked Questions</h2>
        <div style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:10px;overflow:hidden;">
            <button onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display=='none'?'block':'none'"
                    style="width:100%;text-align:left;padding:16px 18px;background:#fff;border:none;cursor:pointer;font-weight:600;font-size:.92rem;color:#1e3a5f;display:flex;justify-content:space-between;font-family:inherit;">
                What makes a daycare licensed? <span style="color:#2563eb;">+</span>
            </button>
        ...
        <div style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:10px;overflow:hidden;">
            <button onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display=='none'?'block':'none'"
                    style="width:100%;text-align:left;padding:16px 18px;background:#fff;border:none;cursor:pointer;font-weight:600;font-size:.92rem;color:#1e3a5f;display:flex;justify-content:space-between;font-family:inherit;">
                What is a good child-to-caregiver ratio? <span style="color:#2563eb;">+</span>
            </button>
            <div style="display:none;padding:14px 18px 16px;font-size:.88rem;color:#444;line-height:1.7;background:#f8fafc;">
        ...
        <div style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:10px;overflow:hidden;">
            <button onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display=='none'?'block':'none'"
                    style="width:100%;text-align:left;padding:16px 18px;background:#fff;border:none;cursor:pointer;font-weight:600;font-size:.92rem;color:#1e3a5f;display:flex;justify-content:space-between;font-family:inherit;">
                How do I find affordable daycare? <span style="color:#2563eb;">+</span>
            </button>
            <div style="display:none;padding:14px 18px 16px;font-size:.88rem;color:#444;line-height:1.7;background:#f8fafc;">
        ...
        <div style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:10px;overflow:hidden;">
            <button onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display=='none'?'block':'none'"
                    style="width:100%;text-align:left;padding:16px 18px;background:#fff;border:none;cursor:pointer;font-weight:600;font-size:.92rem;color:#1e3a5f;display:flex;justify-content:space-between;font-family:inherit;">
                Is home daycare safe? <span style="color:#2563eb;">+</span>
            </button>
            <div style="display:none;padding:14px 18px 16px;font-size:.88rem;color:#444;line-height:1.7;background:#f8fafc;">
                Licensed home daycares are inspected by the state just like center-based care. Always verify the provider holds a current license before enrolling.
            </div>
        </div>
    </div>
</section>
