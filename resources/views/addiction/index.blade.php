@extends('layouts.app')
@section('meta_title', 'Substance Addiction Treatment Guide — 8 Substances Explained | DaycareHub')
...
<script type="application/ld+json">
{
    "@@context": "https://schema.org",
    "@@type": "MedicalWebPage",
    "name": "Substance Addiction Treatment Guide",
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        ...
        {"@@type": "Question", "name": "How long does addiction treatment take?", "acceptedAnswer": {"@@type": "Answer", "text": "Treatment varies by substance and severity: medical detox 3-10 days (longer for benzos), inpatient 30-90 days, IOP 2-4 months, outpatient 3-6 months, MAT ongoing. NIDA research shows 90+ days of combined treatment produces the best long-term outcomes regardless of substance."}},
        {"@@type": "Question", "name": "Does insurance cover substance abuse treatment?", "acceptedAnswer": {"@@type": "Answer", "text": "Yes. The Mental Health Parity and Addiction Equity Act (MHPAEA) and ACA require most insurance plans to cover substance use disorder treatment at the same level as physical health conditions. This includes detox, inpatient, outpatient, IOP, and MAT programs."}},
        ...
        {"@@type": "Question", "name": "Can I work while getting treatment for addiction?", "acceptedAnswer": {"@@type": "Answer", "text": "Yes, with outpatient and IOP programs offering evening/weekend sessions. FMLA protects your job for up to 12 weeks for inpatient treatment. Many employers' EAP programs provide confidential referrals. ADA also protects individuals in recovery from discrimination."}},
        ...
        {"@@type": "Question", "name": "How much does addiction treatment cost?", "acceptedAnswer": {"@@type": "Answer", "text": "Costs vary by program: medical detox $3,000-$10,000, inpatient $15,000-$30,000+, IOP $5,000-$12,000, outpatient $5,000-$10,000, MAT $5,000-$15,000/year. Most insurance covers treatment. State-funded programs, sliding-scale fees, and scholarships are available for uninsured individuals."}}
    ]
}
</script>
@endsection
        ...
        <div class="space-y-4">
            ...
            <div class="bg-red-50 rounded-xl border border-red-200 p-5">
                <div class="flex items-center gap-3 mb-3">
                    <span class="px-3 py-1 rounded-full bg-red-600 text-white text-xs font-bold">SEVERE — Medical Detox Required</span>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <ul class="space-y-1 text-sm text-gray-600">
                                <li class="flex items-start gap-2"><svg class="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> <a href="/treatment/medical-detox" class="text-emerald-600 hover:underline">Medical detox</a> (mandatory — withdrawal can be fatal)</li>
                        ...
                        <div>
                            ...
                            <ul class="space-y-1 text-sm text-gray-600">
                                ...
                                <li>&bull; Benzo detox requires <strong>gradual taper</strong> over weeks-months</li>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <ul class="space-y-1 text-sm text-gray-600">
                                ...
                                <li class="flex items-start gap-2"><svg class="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Medical detox for initial stabilization</li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                ...
                <div class="space-y-2">
                    @foreach(['inpatient-rehab' => 'Inpatient Rehab', 'outpatient-programs' => 'Outpatient', 'medical-detox' => 'Medical Detox', 'medication-assisted-treatment' => 'MAT', 'dual-diagnosis' => 'Dual Diagnosis', 'intensive-outpatient' => 'IOP', 'sober-living' => 'Sober Living'] as $ts => $tn)
            ...
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                <h3 class="text-lg font-bold text-gray-900 mb-4">Insurance Coverage</h3>
                <div class="space-y-2">
            ...
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                ...
                <div class="space-y-2">
                    <a href="/resources/how-to-choose-rehab" class="block text-sm text-gray-600 hover:text-emerald-600">How to Choose a Rehab Center &rarr;</a>
...
<section id="faq" class="py-14 bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-3">
            ...
            <details class="group bg-white rounded-xl border border-gray-100"><summary class="flex justify-between items-center cursor-pointer p-5 font-semibold text-gray-900">How long does treatment take?<svg class="w-5 h-5 text-gray-400 group-open:rotate-180 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></summary><div class="px-5 pb-5 text-gray-600">Detox: 3-10 days. <a href="/treatment/inpatient-rehab" class="text-emerald-600 hover:underline">Inpatient</a>: 30-90 days. <a href="/treatment/intensive-outpatient" class="text-emerald-600 hover:underline">IOP</a>: 2-4 months. <a href="/treatment/outpatient-programs" class="text-emerald-600 hover:underline">Outpatient</a>: 3-6 months. MAT: 12+ months. Research shows <strong>90+ days total</strong> significantly improves long-term outcomes.</div></details>
            <details class="group bg-white rounded-xl border border-gray-100"><summary class="flex justify-between items-center cursor-pointer p-5 font-semibold text-gray-900">Does insurance cover treatment?<svg class="w-5 h-5 text-gray-400 group-open:rotate-180 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></summary><div class="px-5 pb-5 text-gray-600">Yes. The <a href="/insurance" class="text-emerald-600 hover:underline">Mental Health Parity Act</a> requires coverage at the same level as physical health. Most plans cover detox, inpatient, outpatient, IOP, and MAT. <a href="/insurance" class="text-emerald-600 hover:underline">Verify your coverage &rarr;</a></div></details>
            <details class="group bg-white rounded-xl border border-gray-100"><summary class="flex justify-between items-center cursor-pointer p-5 font-semibold text-gray-900">Can I work while getting treatment?<svg class="w-5 h-5 text-gray-400 group-open:rotate-180 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></summary><div class="px-5 pb-5 text-gray-600">Yes, with <a href="/treatment/outpatient-programs" class="text-emerald-600 hover:underline">outpatient</a> and <a href="/treatment/intensive-outpatient" class="text-emerald-600 hover:underline">IOP</a> (evening/weekend sessions). FMLA protects your job for up to 12 weeks for inpatient care. ADA also protects individuals in recovery from workplace discrimination.</div></details>
