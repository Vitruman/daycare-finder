...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        ...
        {"@@type": "Question", "name": "How can I pay for addiction treatment?", "acceptedAnswer": {"@@type": "Answer", "text": "5 main options: (1) Insurance — most plans cover treatment under the Mental Health Parity Act, (2) State-funded programs via SAMHSA block grants, (3) Sliding-scale fees based on income, (4) Payment plans from facilities, (5) Scholarships and grants from nonprofits. Cost should never be a barrier — free options exist in every state."}},
        ...
        <div class="space-y-0">
            ...
            <div class="flex gap-4">
                ...
                <div class="pb-8">
                    ...
                    <p class="text-gray-600 text-sm mt-1">Actively engaged in treatment. This includes <a href="/treatment/medical-detox" class="text-emerald-600 hover:underline">detox</a>, <a href="/treatment/inpatient-rehab" class="text-emerald-600 hover:underline">inpatient care</a>, <a href="/treatment/outpatient-programs" class="text-emerald-600 hover:underline">outpatient therapy</a>, and building new coping skills. The first 90 days are critical — longer treatment produces better outcomes.</p>
                </div>
            </div>
            <div class="flex gap-4">
                <div class="flex flex-col items-center">
