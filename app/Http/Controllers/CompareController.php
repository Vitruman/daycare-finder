...
<p>Most progressive treatment programs now offer <strong>hybrid models</strong>: in-person for initial assessment, detox, and intensive phase, then transition to telehealth for ongoing therapy, MAT management, and aftercare. This maximizes both access and clinical quality.</p>
...
<li><strong>SAMHSA Block Grants</strong> — federal funding for state treatment programs</li>
...
<p>The 28-day rehab model originated not from clinical evidence but from <strong>insurance practices in the 1970s-80s</strong>. Insurance companies standardized coverage at 28 days, and treatment programs adapted. Research has consistently shown this is insufficient for most people with moderate-to-severe addiction.</p>
...
<li>What are the program\'s completion and sobriety rates?</li>
        ...
        'art-therapy-vs-talk-therapy' => [
            ...
            'rows' => [
                ...
                ['feature' => 'Availability', 'a' => 'Specialty programs', 'b' => 'All treatment programs'],
            ],
            'content' => '<h2>Key Differences Explained</h2>
...
<p>These aren\'t really either/or choices. The best treatment programs use <strong>both</strong> — talk therapy as the primary clinical approach, with art/music therapy as complementary modalities that enhance the therapeutic process. Creative therapies are particularly valuable for:</p>
<ul>
...
<p>For <strong>severe opioid, methamphetamine, or alcohol dependence</strong>: abstinence is strongly recommended by medical consensus. The stakes are too high for incremental approaches. For <strong>mild-moderate alcohol or cannabis use</strong>: SMART-style goal-setting with moderation consideration may be appropriate, especially if abstinence feels unrealistic. Either way, some form of <a href="/compare/outpatient-vs-aftercare">ongoing support</a> improves outcomes.</p>',
        ...
        'kaiser-vs-uhc' => [
            ...
            'faqs' => [
                ...
                ['q' => 'Can veterans use both VA and TRICARE?', 'a' => 'Retired veterans may have both VA benefits and TRICARE. VA healthcare is separate from TRICARE and offers its own addiction treatment programs. You can use both systems, though coordination is important to avoid gaps or duplication. VA programs often specialize in combat-related PTSD and co-occurring substance use, which may complement TRICARE-covered treatment.'],
            ],
        ],
        ...
        'hospital-detox-vs-standalone-detox' => [
            ...
            'faqs' => [
                ...
                ['q' => 'Can I get the same treatment quality at a nonprofit?', 'a' => 'Absolutely. Many of the most respected addiction treatment programs in the country are nonprofits, including Hazelden Betty Ford and Phoenix House. Evidence-based treatment (CBT, MAT, group therapy) can be delivered effectively regardless of facility profit status. Focus on clinical qualifications, accreditation, and treatment approach rather than amenity level when evaluating programs.'],
            ],
        ],
