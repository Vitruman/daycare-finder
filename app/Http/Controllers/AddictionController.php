...
class AddictionController extends Controller
{
    private $substances = [
        ...
        'opioids' => [
            ...
            'treatments' => ['Medication-Assisted Treatment (buprenorphine/Suboxone, methadone, naltrexone/Vivitrol)', 'Medical detox with comfort medications', 'Residential treatment programs', 'Intensive outpatient programs', 'Cognitive Behavioral Therapy', 'Contingency management', 'Peer recovery support'],
        ...
        'cocaine' => [
            ...
            'meta_desc' => 'Find cocaine addiction treatment programs. Behavioral therapies, residential care, and outpatient options for cocaine and crack.',
            'substance' => 'Cocaine',
